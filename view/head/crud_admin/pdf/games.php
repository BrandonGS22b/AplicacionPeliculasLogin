...
$query = "SELECT * FROM videojuegos";//SELECCIONAR TODOS LOS DATOS DEL USUARIO
...
$pdf->Cell(20, 10, 'correo', 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
$pdf->Cell(25, 10, 'usuario', 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
...
while ($fila = mysqli_fetch_assoc($resultado)) {
    ...
    $pdf->Cell(140, 10, $fila['nombre'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
    $pdf->Cell(20, 10, $fila['precio'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
    $pdf->Cell(25, 10, $fila['cantidad'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
}

// Generar el archivo PDF
$pdf->Output('BD_videojuegos.pdf', 'D');//El documento se llamara archivo.pdf, ubicado posiblemente en D o en Descargas
