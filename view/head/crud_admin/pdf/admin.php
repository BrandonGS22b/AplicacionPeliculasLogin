...
$query = "SELECT * FROM administracion";//SELECCIONAR TODOS LOS DATOS DEL USUARIO
...
$pdf->Cell(60, 10, 'nombre', 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
$pdf->Cell(60, 10, 'correo', 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
$pdf->Cell(20, 10, 'usuario', 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
...
while ($fila = mysqli_fetch_assoc($resultado)) {
    ...
    $pdf->Cell(60, 10, $fila['nombre'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
    $pdf->Cell(60, 10, $fila['correo'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
    $pdf->Cell(20, 10, $fila['usuario'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
    $pdf->Cell(30, 10, $fila['contrasena'], 1);//SANGRIA EN HORIZONTAL, vertical, dato, 1 DIBUJA BORDES
}

// Generar el archivo PDF
$pdf->Output('BD_admin.pdf', 'D');//El documento se llamara archivo.pdf, ubicado posiblemente en D o en Descargas
