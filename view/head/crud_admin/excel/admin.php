...
/*
    A        B        C        D         E
1   ID    Nombre   Correo   Usuario  Contraseña
2
3
4
5
...
while ($fila = mysqli_fetch_assoc($resultado)) {
    ...
    $sheet->setCellValue('D' . $row, $fila['usuario']);//A$row(2) (el usuario que almacena la base de datos)
    $sheet->setCellValue('E' . $row, $fila['contrasena']);//A$row(2) (la contraseña que almacena la base de datos)
...
$filename = "BD_administracion.xlsx";//Nombre del archivo
