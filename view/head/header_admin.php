            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <?php if (empty($_SESSION['administrador'])): ?>
                        <!-- lo que está aquí arriba para usuarios no administradores -->
                    ...
                    <?php else: ?>
                        <!-- lo que está aquí abajo para administradores -->
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../head/crud_admin/user.php">Administración</a>
                            </li>
                        </ul>
                        <a href="/login/view/home/logout.php" class="boton">Cerrar Sesión</a>
                    <?php endif ?>
